                ...
                <div className="mt-2.5 flex items-center justify-between border-t border-orange-50 pt-2.5">
                  ...
                  <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                    ...
                    <button
                      ...
                      className="rounded-lg p-1.5 text-amber-600 transition-all hover:bg-amber-50"
                      title="Edit"
                    >
                      <Edit size={16} />
                    </button>
                    <button
                      ...
                      className="rounded-lg p-1.5 text-emerald-500 transition-all hover:bg-emerald-50"
